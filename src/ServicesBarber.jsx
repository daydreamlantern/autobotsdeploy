...
const ServicesBarber = () => {
    ...
    useEffect(() => {
        const fetchBarbers = async () => {
            try {
                const response = await axios.get('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/staff'); // Adjust the endpoint as needed
    ...
    const handleNext = async () => {
        ...
        try {
            ...
            const serviceResponse = await axios.get(`https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/services?serviceType=${formData.service}`);
