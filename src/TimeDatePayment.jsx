...
const TimeDatePayment = () => {
    ...
    useEffect(() => {
        const fetchBookedTimes = async () => {
            if (selectedDate) {
                ...
                try {
                    const response = await axios.post('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/booked-times', { date: selectedDate });
    ...
    const handleTimeSelect = async (time) => {
        const response = await fetch('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/check-availability', {
            method: 'POST',
            headers: {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/submit-booking', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
