...
const CreateBook = () => {
    ...
    const handleDateChange = (date) => {
        ...
        axios.post('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/booked-times', { date })
            .then((response) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/create', { ...formData, date: formattedDate })
            .then(() => {
                setLoading(false);
