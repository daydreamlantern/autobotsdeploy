...
const Payments = () => {
    ...
    const fetchPayments = async () => {
        try {
            const response = await axios.get('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/bookings');
    ...
    const handleDelete = async (bookingID) => {
        try {
            await axios.delete(`https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/bookings/delete/${bookingID}`);
    ...
    const handleAccept = async (bookingID) => {
        try {
            const response = await axios.put(`https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/bookings/accept/${bookingID}`);
