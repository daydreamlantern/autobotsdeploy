...
const CustBook = () => {
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            try {
                const response = await axios.get('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/bookings'); // Ensure this endpoint is correct
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/delete/${id}`);
