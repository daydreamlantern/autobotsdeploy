...
const Books = () => {
    ...
    useEffect(() => {
        const fetchCustomersAndTotals = async () => {
            try {
                const customerResponse = await axios.get('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/customers');
                setCustomers(customerResponse.data);

                const totalsResponse = await axios.get('https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/totals');
    ...
    const handleDelete = async (customerId) => {
        try {
            await axios.delete(`https://emperor-deploy-heroku-6a5a3db18c9f.herokuapp.com/delete/${customerId}`);
